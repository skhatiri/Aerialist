...
def run_tree_subprocess(tree_name, x, y, z, r):
    subprocess.Popen(
        [
            "python2",
            "/src/catkin_ws/src/avoidance/spawn_obstacles/src/nodes/spawn_tree.py",
            tree_name,
            x,
            y,
            z,
...
def run_box_subprocess(box_name, l, w, h, x, y, z, r):
    subprocess.Popen(
        [
            "python2",
            "/src/catkin_ws/src/avoidance/spawn_obstacles/src/nodes/spawn_box.py",
            box_name,
            l,
            w,
            h,
...
def run_apartment_subprocess(apartment_name, x, y, z, r):
    subprocess.Popen(
        [
            "python2",
            "/src/catkin_ws/src/avoidance/spawn_obstacles/src/nodes/spawn_apartment.py",
            apartment_name,
            x,
            y,
            z,
...
def launch_node():
    ...
    for temp in obstacle_list:
        node_name = temp[5]
        if temp[4] == "tree":
            x, y, z, r, node_type, node_name_arg = (
                temp[0],
                temp[1],
                temp[2],
                temp[3],
            ...
            x, y, z, r, node_type, node_name_arg, l, w, h = (
                temp[0],
                temp[1],
                temp[2],
                temp[3],
            ...
            run_box_subprocess(
                node_name, str(l), str(w), str(h), str(x), str(y), str(z), str(r)
            )
